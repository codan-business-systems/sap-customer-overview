sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zcustoview/app", ".html");
		...
		return Opa5.extend("zcustoview.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zcustoview/localService/mockserver"], function (mockserver) {
