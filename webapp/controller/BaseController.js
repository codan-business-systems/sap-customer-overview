sap.ui.define([
  ...
  return Controller.extend("zcustoview.controller.BaseController", {
    ...
    sBaseUrl: "/sap/bc/ui5_ui5/sap/z_cus_oview/webapp/",
    ...
    onInit: function() {
      ...
      oCountriesModel.loadData(this.sBaseUrl + "model/countries.json");
      ...
      oTitlesModel.loadData(this.sBaseUrl + "model/titles.json");
      ...
      oEnv.setData({
        minelabFlag: false
      }); //Default view is to hide minelab functionality
     ...
     * @param {boolean} ?bDefaultAsError : If set to true, default value state will be error, otherwise none.
     * @public
     */
    resetErrorStates: function(bDefaultAsError) {
      ...
      var oCountryInput = sap.ui.getCore().byId("country");

      if (oCountryInput) {
        sap.ui.getCore().byId("country").toggleStyleClass("selectError", bDefaultAsError);
      }
